            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                ...
                <div id="event-list" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    @forelse ($events as $event)
                        <div class="event-item border rounded-lg p-4 dark:bg-gray-700 dark:border-gray-600 relative flex flex-col justify-between">
                            <button onclick="deleteEvent('{{ $event->id }}')"
                                class="absolute group top-2 right-2 py-2 px-3 bg-gray-500 text-white rounded-full hover:bg-gray-100 hover:text-gray-950 dark:hover:bg-gray-200 dark:hover:text-gray-800 transition-transform transform hover:scale-110 focus:outline-none z-30">
                                <i class="fas fa-trash-alt"></i>
                            </button>
                            <button onclick="window.location.href='{{ route('events.edit', $event->id) }}'"
                                class="absolute group top-14 right-2 py-2 px-3 bg-gray-500 text-white rounded-full hover:bg-gray-100 hover:text-gray-950 dark:hover:bg-gray-200 dark:hover:text-gray-800 transition-transform transform hover:scale-110 focus:outline-none z-30">
                    ...
                    @empty
                        <p class="text-center col-span-3 text-gray-600 dark:text-gray-400">Tidak ada data event.</p>
                    @endforelse
                </div>
